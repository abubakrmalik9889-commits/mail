...
export default function Settings() {
  ...
  async function saveSettings() {
    localStorage.setItem('mailflow_smtp', JSON.stringify(form));
  ...
  React.useEffect(() => {
    const saved = localStorage.getItem('mailflow_smtp');
...
FROM_EMAIL=${form.fromEmail || 'your@gmail.com'}`}
        ...
        <div style={{ fontSize: 12, color: 'var(--text-3)', marginTop: 10 }}>✨ These settings are saved locally in your browser and used when you send campaigns</div>
      </Card>
